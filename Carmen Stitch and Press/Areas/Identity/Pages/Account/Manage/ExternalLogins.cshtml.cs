...
namespace Carmen_Stitch_and_Press.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (_userStore is IUserPasswordStore<CarmenStitchAndPressUserModel> userPasswordStore)
            {
